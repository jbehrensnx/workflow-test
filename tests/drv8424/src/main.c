...
static void *drv8424_setup(void)
{
	static struct drv8424_fixture fixture = {
...
static void drv8424_before(void *f)
{
	struct drv8424_fixture *fixture = f;
...
static void drv8424_after(void *f)
{
	struct drv8424_fixture *fixture = f;
	(void)stepper_disable(fixture->dev);
}

ZTEST_F(drv8424, test_micro_step_res_set)
{
...
ZTEST_F(drv8424, test_actual_position_set)
{
	int32_t pos = 100u;
...
ZTEST_F(drv8424, test_is_not_moving_when_disabled)
{
	int32_t steps = 100;
	bool moving = true;
...
ZTEST_F(drv8424, test_position_not_updating_when_disabled)
{
	int32_t steps = 1000;
...
ZTEST_F(drv8424, test_is_not_moving_when_reenabled_after_movement)
{
	int32_t steps = 1000;
	bool moving = true;
...
ZTEST_F(drv8424, test_position_not_updating_when_reenabled_after_movement)
{
	int32_t steps = 1000;
	int32_t position_1 = 0;
	int32_t position_2 = 0;
...
ZTEST_F(drv8424, test_move_to_positive_direction_movement)
{
	int32_t pos = 50;
...
ZTEST_F(drv8424, test_move_to_negative_direction_movement)
{
	int32_t pos = -50;
...
ZTEST_F(drv8424, test_move_to_identical_current_and_target_position)
{
	int32_t pos = 0;
...
ZTEST_F(drv8424, test_move_to_is_moving_true_while_moving)
{
	int32_t pos = 50;
	bool moving = false;
...
ZTEST_F(drv8424, test_move_to_is_moving_false_when_completed)
{
	int32_t pos = 50;
	bool moving = false;
...
ZTEST_F(drv8424, test_move_to_no_movement_when_disabled)
{
	int32_t pos = 50;
	int32_t curr_pos = 50;
	int32_t ret = 0;
...
ZTEST_F(drv8424, test_move_by_zero_steps_no_movement)
{
	int32_t steps = 0;
...
ZTEST_F(drv8424, test_move_by_zero_step_interval)
{
	int32_t steps = 100;
	int32_t ret = 0;
	int32_t pos = 100;
...
ZTEST_F(drv8424, test_move_by_is_moving_true_while_moving)
{
	int32_t steps = 50;
	bool moving = false;
...
ZTEST_F(drv8424, test_move_by_is_moving_false_when_completed)
{
	int32_t steps = 50;
	bool moving = true;
...
ZTEST_F(drv8424, test_move_by_no_movement_when_disabled)
{
	int32_t steps = 100;
...
ZTEST_F(drv8424, test_run_positive_direction_correct_position)
{
...
ZTEST_F(drv8424, test_run_negative_direction_correct_position)
{
	uint64_t step_interval = 20000000;
	int32_t steps = 0;
...
ZTEST_F(drv8424, test_run_zero_step_interval_correct_position)
{
...
ZTEST_F(drv8424, test_run_is_moving_true_when_step_interval_greater_zero)
{
	uint64_t step_interval = 20000000;
	bool moving = false;
...
ZTEST_F(drv8424, test_run_no_movement_when_disabled)
{
	uint64_t step_interval = 20000000;
	int32_t steps = 50;
	int32_t ret = 0;
...
ZTEST_SUITE(drv8424, NULL, drv8424_setup, drv8424_before, drv8424_after, NULL);
